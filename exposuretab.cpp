...
void ExposureTab::createGui() {
  ...
  m_layout->addWidget(new QLabel(tr("Exposure:")), 1, 0);
  m_layout->addWidget(m_exposure_ledit, 1, 1);
  m_layout->addWidget(new QLabel(tr("Num Images:")), 2, 0);
  m_layout->addWidget(m_nimages_ledit, 2, 1);
  m_layout->addWidget(new QLabel(tr("Binning")), 3, 0);
  m_layout->addWidget(m_binning_ledit, 3, 1);
  m_layout->addWidget(m_start_button, 4, 0);
  m_layout->addWidget(m_exit_button, 4, 1);
